...
class Question extends \yii\db\ActiveRecord
{
     ...
     * Gets query for [[Test]].
     *
     * @return \yii\db\ActiveQuery|\frontend\models\query\TestQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \frontend\models\query\QuestionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \frontend\models\query\QuestionQuery(get_called_class());
    }
}
