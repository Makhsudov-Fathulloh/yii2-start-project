...
class Test extends \yii\db\ActiveRecord
{
     ...
     *
     * @return \yii\db\ActiveQuery|\frontend\models\query\QuestionQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \frontend\models\query\TestQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \frontend\models\query\TestQuery(get_called_class());
    }
}
