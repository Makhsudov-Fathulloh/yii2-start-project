...
class LessonStudent extends \yii\db\ActiveRecord
{
     ...
     *
     * @return \yii\db\ActiveQuery|\common\models\query\CourseStudentQuery
     */
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\LessonStudentQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\LessonStudentQuery(get_called_class());
    }
}
